<meta http-equiv="refresh" content="15;url=<?php echo base_url(); ?>" />
<style>
	body {
...
<div class="row">
    ...
    <div class="col-sm-4 forgetForm">
		<h4 id="font2">You can edit or delete your post in 30 minutes. You will be redirected to homepage after 15 seconds, or <a href="<?php echo base_url(); ?>">click here</a></h4>
    </div>
</div>
